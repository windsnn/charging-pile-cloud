...
import com.trick.pile.fallback.AsyncOrderFallback;
...
@FeignClient(name = "order-service", contextId = "async", configuration = AsyncFeignConfig.class, fallbackFactory = AsyncOrderFallback.class)
