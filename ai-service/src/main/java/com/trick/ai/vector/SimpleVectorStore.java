...
public class SimpleVectorStore extends AbstractObservationVectorStore {
    ...
    public void doAdd(@NonNull List<Document> documents) {
        ...
        for (Document document : documents) {
            ...
            SimpleVectorStoreContent storeContent = new SimpleVectorStoreContent(document.getId(), Objects.requireNonNull(document.getText()),
    ...
    public void save(File file) {
        ...
        try {
            if (!file.exists()) {
                log.info("Creating new vector store file: {}", file);
                try {
                ...
                log.info("Overwriting existing vector store file: {}", file);
            }
